...
const COMPOSITE_INDEX_SERIES: IndexPoint[] = [
  ...
  { date: '2018-09-20', value: 2930.75 },
  { date: '2018-12-24', value: 2351.1 },
...
const CRISIS_EVENTS: CrisisEvent[] = [
  ...
  },
  {
    id: 'pre-war-bear',
    rangeLabel: '1937–42',
    nameKey: 'LEARN_TIM.EVT_PREWAR_NAME',
    peakDate: '1937-03-10',
    troughDate: '1942-04-28',
    troughValue: 8.62,
    drawdownPct: -52,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_9_YEARS',
    year1ReturnPct: 46,
    year3ReturnPct: 76,
    narrativeKey: 'LEARN_TIM.EVT_PREWAR_NARRATIVE',
  },
  {
    id: 'kennedy-slide',
    rangeLabel: '1961–62',
    ...
    troughValue: 52.32,
    drawdownPct: -28,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_21_MONTHS',
    year1ReturnPct: 34,
    year3ReturnPct: 62,
  ...
  },
  {
    ...
    troughValue: 62.28,
    drawdownPct: -48,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_75_YEARS',
    year1ReturnPct: 44,
    year3ReturnPct: 48,
  ...
  },
  {
    ...
    troughValue: 295.46,
    drawdownPct: -20,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_7_MONTHS',
    year1ReturnPct: 32,
    year3ReturnPct: 57,
  ...
  },
  {
    ...
    troughValue: 965.8,
    drawdownPct: -12,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_2_MONTHS',
    year1ReturnPct: -14,
    year3ReturnPct: 16,
  ...
  },
  {
    ...
    troughValue: 1099.23,
    drawdownPct: -19,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_10_MONTHS',
    year1ReturnPct: 30,
    year3ReturnPct: 77,
  ...
  },
  {
    id: 'q4-2018',
    rangeLabel: '2018',
    nameKey: 'LEARN_TIM.EVT_Q4_2018_NAME',
    peakDate: '2018-09-20',
    ...
    year1ReturnPct: 37,
    year3ReturnPct: 101,
    narrativeKey: 'LEARN_TIM.EVT_Q4_2018_NARRATIVE',
  },
  {
    id: 'covid-19',
    rangeLabel: '2020',
    ...
    troughValue: 2237.4,
    drawdownPct: -34,
    recoveryLabelKey: 'LEARN_TIM.RECOVERY_6_MONTHS',
    year1ReturnPct: 78,
    year3ReturnPct: 79,
