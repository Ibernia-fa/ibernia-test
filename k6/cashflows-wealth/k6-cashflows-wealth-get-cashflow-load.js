/**
 * Load test GET /api/v1/cashflows/{cashflowId} for /cashflows/{id}/wealth (shell).
 *
 * cd C:\Users\gulle\source\repos\load-testing-k6
 * k6 run k6/cashflows-wealth/k6-cashflows-wealth-get-cashflow-load.js -e SIGNUP_ROPC_CLIENT_ID=... -e SIGNUP_ROPC_CLIENT_SECRET=...
 */
...
const SCRIPT_TAG = 'k6-cashflows-wealth-get-cashflow-load';
const GLOBAL_SEED = '__k6CfWealthSeed_getcf';
...
const dur = new Trend('cashflows_wealth_get_cashflow_ms');
const errs = new Counter('cashflows_wealth_get_cashflow_errors');
const oks = new Counter('cashflows_wealth_get_cashflow_success');
const errBuckets = createHttpErrorBuckets('cashflows_wealth_get_cashflow_err');

export const options = {
  scenarios: {
    cashflows_wealth_get_cashflow: {
...
export default function (data) {
  ...
  const res = http.get(url, {
    headers: hdrs,
    tags: { name: 'cashflows_wealth_get_cashflow', vu: String(__VU) },
...
export const handleSummary = singleApiHandleSummaryFactory({
  ...
  expectedStatus: 200,
  durMetricName: 'cashflows_wealth_get_cashflow_ms',
  errMetricName: 'cashflows_wealth_get_cashflow_errors',
  okMetricName: 'cashflows_wealth_get_cashflow_success',
  errBucketDefs: errBuckets.defs,
  reportFilename: 'k6/cashflows-wealth/reports/cashflows-wealth-get-cashflow-load-report.json',
});
